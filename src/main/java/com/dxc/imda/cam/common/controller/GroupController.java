...
import com.dxc.imda.cam.neupc.controller.NeupcGroupController;
...
public class GroupController {
	...
	@Autowired
	private NeupcGroupController neupcGroupController;
	...
	public ResponseEntity<Object> getGroupInfo(HttpServletRequest request, 
		...
		if (neupcAccountId.equalsIgnoreCase(accountId)) {
			responseEntity = neupcGroupController.getGroupInfo(request, response, reqParamMap, reqBodyMap);
		}	
	...
	public ResponseEntity<Object> getGroupInfoList(HttpServletRequest request, 
		...
		if (neupcAccountId.equalsIgnoreCase(accountId)) {
			responseEntity = neupcGroupController.getGroupInfoList(request, response, reqParamMap, reqBodyMap);
		}	
	...
	public ResponseEntity<Object> updateGroup(HttpServletRequest request, 
		...
		if (neupcAccountId.equalsIgnoreCase(accountId)) {
			responseEntity = neupcGroupController.updateGroup(request, response, reqParamMap, reqBody);
		}	
