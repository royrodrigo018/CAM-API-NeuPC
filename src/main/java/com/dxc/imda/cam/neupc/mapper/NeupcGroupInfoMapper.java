...
@Component
public class NeupcGroupInfoMapper {
	
	private Logger logger = LoggerFactory.getLogger(this.getClass());
	
	public GroupInfo convertUserRoleToJSON(UserRole userRole, List<UserProfile> userProfiles) {
		...
		try {
			...
			groupInfo.setDisplayName(userRole.getRoleDesc());
			
			Meta meta = getMeta(userRole);
			List<Member> members = getMemberList(userRole, userProfiles);					
	...
	private List<Member> getMemberList(UserRole userRole, List<UserProfile> userProfiles){
